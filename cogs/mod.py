...
async def paladin_check(bot: DiscordBot, guild: discord.Guild, actor, action: str):
    ...
    """
    antinuke_cog = bot.cogs.get("AntiNuke")
    if not antinuke_cog:
        return
    ...
    if member:
        await antinuke_cog._register_attempt(guild, member, action)
...
class Moderator(commands.Cog):
    ...
    async def kick(self, ctx: CustomContext, member: discord.Member, *, reason: str = None):
        ...
        # The antinuke audit-log listener registers the strike after execution.
